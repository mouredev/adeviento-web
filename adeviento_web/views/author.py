...
from adeviento_web.styles.styles import Color, Size, SizeEM, TextColor
    ...
    return rx.vstack(
        ...
        rx.flex(
            rx.image(
                ...
                border_radius="50%",
                margin_right=SizeEM.SMALL.value,
                margin_bottom=SizeEM.SMALL.value,
            ),
            rx.vstack(
                rx.el.span(
                ...
                rx.el.span(
                    ...
                    rx.el.span(
                        "@mouredev", color=TextColor.ACCENT.value, font_size=SizeEM.DEFAULT.value
                    ),
                    ".",
                ),
                _author_buttons(),
